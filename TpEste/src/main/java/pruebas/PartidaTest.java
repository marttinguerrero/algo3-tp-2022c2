...
public class PartidaTest {
	...
	@Test
	public void testPartidaRecienEmpezadaSigueEnJuego() {

		assertFalse(partida.finDePartida());
	...
	@Test 
	public void testValidarTodasLasPiezas() {
	...
	public void testGuardarPartida() throws IOException {
		String archivo = "/home/martin/Algoritmos 3/tpsi/src/main/java/partida5.csv"; //Ruta para crear archivo
	...
	public void testCargarPartida() throws IOException, ClassNotFoundException {
		String archivo = "/home/martin/Algoritmos 3/tpsi/src/main/java/partida5.csv"; //Ruta del archivo ya creado
