...
public class Vista{
	...
	//FICHAS VERDES
	private final Image EN_BLANCO_VERDE = new Image(getClass().getResourceAsStream("res/BanderaVerde.png"), TAM_CASILLA, TAM_CASILLA, false, false);
...
//		contextoCanvas.setFill(Color.WHITE);
	...
	public void dibujarMenu(Stage escenario)     {
		...
		botonCargarPartidaContraJugador = new Button("Cargar partida contra jugador");
...
//	}
	...
	public void apretarCargarPartidaContraJugador(EventHandler<MouseEvent> eventHandler) {
		botonCargarPartidaContraJugador.setOnMouseClicked(eventHandler);
	}
